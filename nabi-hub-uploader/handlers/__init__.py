...
def get_handlers_router() -> Router:
    ...
    from handlers.admin_locks import router as admin_locks_router
    ...
    main_router.include_router(admin_manage_router)
    main_router.include_router(admin_channel_router)
    main_router.include_router(admin_locks_router)         # ← جدید: قفل عضویت و واکنش
